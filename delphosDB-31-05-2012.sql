...
insert  into `footer`(`id`,`contenido`,`fecha`) values (47,'Se suspende la clase de Sistemas Operativos de hoy martes a las 11:30','2012-04-11'),(48,'Reunion de el CEAL DIICC jueves 25 a las 13:00 no faltar','2012-04-11'),(50,'Seminario de Incorporacion de TI martes 23 a las 17:00 Auditorio edificio de Minas','2012-04-11'),(51,'Prueba de Teoria Economica mañana viernes a las 11:30 sala DIIC-2 veamos que','2012-04-14'),(52,'Inscripciones abiertas para Ayudantes DIICC dejar datos en Secretaria','2012-04-14');
